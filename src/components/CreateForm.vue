    ...
    <form
      ...
      <div class="relative w-full">
        <input
          ...
          v-model="name.value"
          :class="[
            'w-full p-3 pr-10 text-white placeholder-gray-400 rounded-md focus:outline-none focus:ring-2',
            name.invalid
        ...
        <i
          class="fas fa-user absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none"></i>
      </div>
